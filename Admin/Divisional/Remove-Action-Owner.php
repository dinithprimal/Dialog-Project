<?php
    ...
    $slRO = "DELETE FROM divactionowners WHERE empNo = '$empNo_removeA'";
    if($conn->query($slRO) === TRUE){
        ...
        $queryActivity = "INSERT INTO divactivity (indexRisk, empNo, Date, Time, Des, field,  updatedValue) VALUES ('$indexRisk', '$empNo', '$Date', '$Time', 'Remove Action Owner','Action Owners', '$AOname')";
