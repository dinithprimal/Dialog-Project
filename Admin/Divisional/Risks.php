    ...
    <body>
                                                ...
                                                <div class="card-body" style="width: 100%;">
                                                    ...
                                                    <small>
                                                        <table cellpadding="3" cellspacing="0" border="0" style="width: 67%; margin: 0 auto 2em auto;">
                                                            <tbody>
                                                                <tr id="filter_col4" data-column="0">
                                                                    <td>Division</td>
                                                                    <td align="center">
                                                                        <select  class="column_filter" id="col0_filter" onchange="remmoveErrorRiskUnit(this)" class="form-control form-select" style="width: 70%;">
                                                        ...
                                                        <table id="programsHistory" style="width:100%;" class="table table-sm table-striped table-hover">
                                                            <thead>
                                                                <tr>
                                                                    <th style="width: 10%"><small>Division</small></th>
                                                            ...
                                                            <tbody>
                                                            <?php
                                                                $querySelIndex = "SELECT indexRisk FROM divtrindex ORDER BY id DESC";
                                                                ...
                                                                if(mysqli_num_rows($resultSelIndex) > 0){
                                                                    while($rowIndex = mysqli_fetch_array($resultSelIndex)){
                                                                        ...
                                                                        $query = "SELECT indexRisk, description, cateory, mainUnit, currentStatus, reporter, reportedDate, keyRiskTag, closeStatus, reportedTime FROM divrisk WHERE indexRisk = '$index'";
        ...
        <script type="text/javascript">
            ...
            function remmoveErrorRiskUnit(RU){
                    filterColumn( $(RU).parents('tr').attr('data-column') );
                }
