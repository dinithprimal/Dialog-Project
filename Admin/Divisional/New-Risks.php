                                                        ...
                                                        <div class="row d-flex justify-content-between mt-3 pt-1">
                                                            ...
                                                            <div class="col-4">
                                                                <div class="table-responsive d-flex" style="height: 200px; overflow: auto; overflow-x: auto; overflow-y: auto;">
                                                                    <table class="table table-sm table-striped table-hover align-top" id="riskOwners">
                                                                        <thead>
                                                                            <tr>
                                                ...
                                                <div class="card-body p-3">
                                                    <div class="form-control p-3 mb-3">
                                                        ...
                                                        <div class="row d-flex justify-content-between align-items-center mt-3">
                                                            ...
                                                            <div class="col-8">
                                                                <select name="controlEffectiveness" id="controlEffectiveness" class="form-control form-select" onchange="remmoveErrorConEff(this)" aria-label="Default select example" style="width: 70%;">
