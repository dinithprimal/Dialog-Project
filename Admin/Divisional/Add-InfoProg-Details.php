<?php
    ...
    $sqlInfoProgDetails = "INSERT INTO divinfogatherdetails (idInfo, indexRisk, empNo, descrition, date, time) VALUES ('$idInfo', '$indexRisk', '$empNo', '$option', '$Date', '$Time')";
    if($conn->query($sqlInfoProgDetails) === TRUE){
        $queryActivity = "INSERT INTO divactivity (indexRisk, empNo, Date, Time, Des) VALUES ('$indexRisk', '$empNo', '$Date', '$Time', '$des')";
