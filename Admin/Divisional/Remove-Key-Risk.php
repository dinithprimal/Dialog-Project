<?php
    ...
    $slRO = "UPDATE divrisk SET keyRiskTag = '0' WHERE indexRisk = '$indexRisk'";
    if($conn->query($slRO) === TRUE){
        ...
        $mail->Body   .= 'As per senior management direction, the risk <em>'.$indexRisk.'</em> remove from "Key Risk" tag.<br>';
        ...
        $queryActivity = "INSERT INTO divactivity (indexRisk, empNo, Date, Time, Des) VALUES ('$indexRisk', '$empNo', '$Date', '$Time', 'Removed Key Risk Tag')";
