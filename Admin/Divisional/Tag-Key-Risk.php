<?php
    ...
    $slRO = "UPDATE divrisk SET keyRiskTag = '1' WHERE indexRisk = '$indexRisk'";
    if($conn->query($slRO) === TRUE){
        ...
        $mail->Body   .= 'As per senior management direction, the risk <em>'.$indexRisk.'</em> tagged as a "Key Risk". Thus, we should need closely monitor the risk and related risk mitigating activities.<br>';
        ...
        $queryActivity = "INSERT INTO divactivity (indexRisk, empNo, Date, Time, Des) VALUES ('$indexRisk', '$empNo', '$Date', '$Time', 'Tagged as Key Risk')";
