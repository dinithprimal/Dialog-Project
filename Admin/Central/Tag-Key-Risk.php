<?php
    ...
    $slRO = "UPDATE risk SET keyRiskTag = '1' WHERE indexRisk = '$indexRisk'";
    if($conn->query($slRO) === TRUE){
        ...
        $queryActivity = "INSERT INTO activity (indexRisk, empNo, Date, Time, Des) VALUES ('$indexRisk', '$empNo', '$Date', '$Time', 'Tagged as Key Risk')";
