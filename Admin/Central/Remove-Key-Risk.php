<?php
    ...
    $slRO = "UPDATE risk SET keyRiskTag = '0' WHERE indexRisk = '$indexRisk'";
    if($conn->query($slRO) === TRUE){
        ...
        $queryActivity = "INSERT INTO activity (indexRisk, empNo, Date, Time, Des) VALUES ('$indexRisk', '$empNo', '$Date', '$Time', 'Removed Key Risk Tag')";
