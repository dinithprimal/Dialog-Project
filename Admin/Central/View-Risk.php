<?php
    ...
    if(isset($_SESSION['user'])){
        ...
        $queryUserDetails = "SELECT idUser, fullName, empNo, role FROM user_details WHERE username = '$username'";
    ...
    <body>
                            ...
                            <div class="container">
                                <h4 align="center">
                                    <small>
                                        ...
                                        ?>
                                            <span class="text-danger"><b> (Request to close this risk)</b></span>
                                        <?php
                                            }
                                        ?>
                                    </small>
                                    ...
                                    <span class="text-danger"><small><small><small>
                                        <?php
                                            if($activeStatus == "Inactive"){
                                                ...
                                                echo    "Requesting transfer this risk to Divisional Risk Regstry";
                                            }
                                        ?>
                                    </small></small></small>
                                </h4>
                                <br>
                                <?php
                                    if($risk_details['closeStatus'] == 1 | $risk_details['closeStatus'] == 2){
                                ?>
                                                    ...
                                                    <div class="row row-cols-1 row-cols-md-1 row-cols-lg-2 row-cols-xl-2 g-1 g-lg-2">
                                                        ...
                                                        <div class="col mb-4 mb-lg-1">
                                                            <div class="row justify-content-between align-item-center">
                                                                ...
                                                                ?>
                                                                    <button style="float: right" type="button" id="closeReject" name="closeReject" class="btn btn-sm btn-danger mx-2" >Reject</button>
                                                                    <button style="float: right" type="button" id="closeAccept" name="closeAccept" class="btn btn-sm btn-success mx-2" >Accept</button>
                                                                <?php
                                                                    }
                                                                ?>
                                                                </div>
                                ...
                                <div class="row row-cols-1 g-1 g-lg-2 mb-2">
                                    ...
                                    <?php
                                        if($risk_details['keyRiskTag'] == 0 & $risk_details['closeStatus'] == 0){
                                    ?>
                                    ...
                                    ?>
                                        <button style="float: right" type="button" id="removeKeyRisk" name="removeKeyRisk" class="btn btn-sm btn-danger mx-2" <?php if($activeStatus != "Active"){  echo    "disabled"; }  ?>>Remove Key Risk Tag</button>
                                    <?php
                                        }
                                        if($activeStatus == "Active" & $risk_details['closeStatus'] == 0){
                                    ?>
                                        <button style="float: right" type="button" id="send2Div" name="send2Div" class="btn btn-sm btn-danger mx-2" >Send This to Divisional Risk Registry</button>
                                    <?php
                                        }
                                        ...
                                        <div class="p-0">
                                            <div class="card" style="width: auto; height: auto;">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    ?>
                                                        <button type="button" data-bs-toggle="modal" data-bs-target="#Close-Risk" class="btn btn-sm btn-danger mx-2" <?php if($activeStatus != "Active" | (!(in_array($risk_details['currentStatus'], $actionStatus)))){  echo    "disabled"; }  ?>>Close this Risk</button>
                                                    <?php
                                                        }
                                                    ?>
                                                    </div>
        ...
        <script type="text/javascript">
            ...
            $('#send2Div').click(function(){
                if(confirm("Are you sure you want to send this risk to divisional risk registry?")){
            ...
            $('#rejectsend2Div').click(function(){
                if(confirm("Are you sure you want to reject this request?")){
                    ...
                    var empNo = `<?php   echo    $userDetails['empNo'];   ?>`;
                    $.ajax({
                        url: "Reject-Send-Risk-Division.php",
                        method: "POST",
            ...
            $('#closeAccept').click(function(){
                $("#closeAccept").html("Accepting...");
                document.getElementById('closeAccept').disabled = true;
                document.body.style.cursor = 'wait';
                var comment = `<?php   echo    $risk_details['closeComment'];   ?>`;
                var indexRisk = `<?php   echo    $riskIndex; ?>`;
                var empNo = `<?php   echo    $userDetails['empNo'];   ?>`;
                $.ajax({
                    url: "Close-Risk.php",
            ...
            $('#closeReject').click(function(){
                $("#closeReject").html("Rejecting...");
                document.getElementById('closeReject').disabled = true;
                document.body.style.cursor = 'wait';
                var indexRisk = `<?php   echo    $riskIndex; ?>`;
                var empNo = `<?php   echo    $userDetails['empNo'];   ?>`;
                $.ajax({
                    url: "Reject-Close-Risk.php",
                    method: "POST",
                    data: {empNo:empNo,indexRisk:indexRisk,comment:comment},
                    dataType: "text",
                    success: function(data){
