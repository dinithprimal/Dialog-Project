...
<html lang="en">
    <head>
        ...
        <title>Risks - Risk Register Management System</title>
    </head>
    <body>
        <!-- navbar -->
                            ...
                            <div class="container mb-3">
                                    ...
                                    <div class="col">
                                            <div class="card" style="width: auto; height: auto;">
                                                <div class="card-body" style="width: 100%;">
                                                    <h5 class="card-title">Export All Risks</h5>
                                                    <h6 class="card-subtitle mb-2 text-muted"><small>You can export all the risk details to excell sheet clicking bellow button.</small></h6>
                                                    <br>
                                                    <div align="center">
                                                    <button class="btn btn-sm btn-info" name="export" id="export" type="button" ><i class="fas fa-download"></i> Export</button>
                                                    </div>
                                                </div>
                                            </div>
                                    </div>
                                ...
                                <div class="row g-1 g-lg-2 mt-2">
                                    <div class="col">
                                            <div class="card" style="width: auto; height: auto;">
                                                <div class="card-body" style="width: 100%;">
                                                    <h5 class="card-title">All Risks</h5>
                                                    <h6 class="card-subtitle mb-2 text-muted"><small>Shown all registered risks. Please select the risk to view and update.</small></h6>
                                                    <br>
                                                    <small>
                                                        <table cellpadding="3" cellspacing="0" border="0" style="width: 67%; margin: 0 auto 2em auto;">
                                                            <tbody>
                                                                ...
                                                                <tr id="filter_col8" data-column="8" class="form-check form-switch d-flex justify-content-between align-items-center">
                                                                    <td>Key Risks</td>
                                                                    <td align="center"><input type="checkbox" onchange="remmoveErrorRiskUnitDes(this)" value="KR" class="form-check-input form-switch" id="col8_filter"></td>
                                                                </tr>
                                                                <tr id="filter_col9" data-column="9" class="form-check form-switch d-flex justify-content-between align-items-center">
                                                                    <td>Closed Risks</td>
                                                                    <td align="center"><input type="checkbox" onchange="remmoveErrorRiskUnitDes(this)" value="Closed" class="form-check-input form-switch" id="col9_filter"></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        ...
                                                        <table id="programsHistory" style="width:100%;" class="table table-sm table-striped table-hover">
                                                            <thead>
                                                                <tr>
                                                                    <th style="width: 10%"><small>Risk Index</small></th>
                                                                    <th style="width: 10%"><small>Category</small></th>
                                                                    <th style="width: 19%"><small>Description</small></th>
                                                                    <th style="width: 10%"><small>Main Unit</small></th>
                                                                    <th style="width: 13%"><small>Current Status</small></th>
                                                                    <th style="width: 13%"><small>Action Owners</small></th>
                                                                    <th style="width: 10%"><small>Reported By</small></th>
                                                                    <th style="width: 8%"><small>Date</small></th>
                                                                    <th style="width: 7%"><small>Time</small></th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                            <?php
                                                                $querySelIndex = "SELECT indexRisk FROM trindex ORDER BY id DESC";
                                                                ...
                                                                if(mysqli_num_rows($resultSelIndex) > 0){
                                                                    while($rowIndex = mysqli_fetch_array($resultSelIndex)){
                                                                        ...
                                                                        $query = "SELECT indexRisk, description, cateory, mainUnit, currentStatus, reporter, reportedDate, keyRiskTag, closeStatus, reportedTime FROM risk WHERE indexRisk = '$index'";
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <?php
                                                                        $sqlActionOwnerEMP = "SELECT empNo FROM actionowners WHERE indexRisk = '$index'";
        ...
        <script type="text/javascript">
            ...
            function remmoveErrorRiskUnitDes(RU){
            ...
            $('#export').click(function(){
                location.href='Export-Excel.php';
