<?php
    ...
    $sqlUpdateBI = "UPDATE risk SET riskAlert = '$riskAlert' WHERE indexRisk = '$indexRisk'";
    if($conn->query($sqlUpdateBI) === TRUE){
        ...
        $queryActivity = "INSERT INTO activity (indexRisk, empNo, Date, Time, Des, field, intialValue, updatedValue) VALUES ('$indexRisk', '$empNo', '$Date', '$Time', 'Update Risk Alert','Risk Alert', '$initialVal', '$riskAlert')";
