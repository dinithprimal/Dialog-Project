...
<html lang="en">
    ...
    <body>
                                        ...
                                        <div class="card" style="width: auto; height: 100%;">
                                            <div class="card-header justify-content-between">
                                                <small>
                                                    ...
                                                    <?php
                                                        $sqltot = "SELECT COUNT(*) AS tot FROM risk WHERE closeStatus = 0";
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td align="right" class="px-3">
                                                                    <small><small>
                                                                    <?php
                                                                        $sqlKDBR = "SELECT COUNT(*) AS KDBR FROM risk WHERE closeStatus = 0 AND (cateory = 'DR / BCM Risk' AND keyRiskTag = 1)";
                                                                ...
                                                                <td align="right" class="px-3">
                                                                    <small><small>
                                                                    <?php
                                                                        $sqlDBR = "SELECT COUNT(*) AS DBR FROM risk WHERE closeStatus = 0 AND (cateory = 'DR / BCM Risk' AND keyRiskTag = 0)";
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="right" class="px-3">
                                                                    <small><small>
                                                                    <?php
                                                                        $sqlKEPR = "SELECT COUNT(*) AS KEPR FROM risk WHERE closeStatus = 0 AND (cateory = 'Economic & Political Risk' AND keyRiskTag = 1)";
                                                                ...
                                                                <td align="right" class="px-3">
                                                                    <small><small>
                                                                    <?php
                                                                        $sqlEPR = "SELECT COUNT(*) AS EPR FROM risk WHERE closeStatus = 0 AND (cateory = 'Economic & Political Risk' AND keyRiskTag = 0)";
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="right" class="px-3">
                                                                    <small><small>
                                                                    <?php
                                                                        $sqlKRER = "SELECT COUNT(*) AS KRER FROM risk WHERE closeStatus = 0 AND (cateory = 'Environmental Risk' AND keyRiskTag = 1)";
                                                                ...
                                                                <td align="right" class="px-3">
                                                                    <small><small>
                                                                    <?php
                                                                        $sqlER = "SELECT COUNT(*) AS ER FROM risk WHERE closeStatus = 0 AND (cateory = 'Environmental Risk' AND keyRiskTag = 0)";
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="right" class="px-3">
                                                                    <small><small>
                                                                    <?php
                                                                        $sqlKRFR = "SELECT COUNT(*) AS KRFR FROM risk WHERE closeStatus = 0 AND (cateory = 'Financial Risk' AND keyRiskTag = 1)";
                                                                ...
                                                                <td align="right" class="px-3">
                                                                    <small><small>
                                                                    <?php
                                                                        $sqlFR = "SELECT COUNT(*) AS FR FROM risk WHERE closeStatus = 0 AND (cateory = 'Financial Risk' AND keyRiskTag = 0)";
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="right" class="px-3">
                                                                    <small><small>
                                                                    <?php
                                                                        $sqlKISR = "SELECT COUNT(*) AS KISR FROM risk WHERE closeStatus = 0 AND (cateory = 'Information Security Risk' AND keyRiskTag = 1)";
                                                                ...
                                                                <td align="right" class="px-3">
                                                                    <small><small>
                                                                    <?php
                                                                        $sqlISR = "SELECT COUNT(*) AS ISR FROM risk WHERE closeStatus = 0 AND (cateory = 'Information Security Risk' AND keyRiskTag = 0)";
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="right" class="px-3">
                                                                    <small><small>
                                                                    <?php
                                                                        $sqlKRMR = "SELECT COUNT(*) AS KRMR FROM risk WHERE closeStatus = 0 AND (cateory = 'Market Risk' AND keyRiskTag = 1)";
                                                                ...
                                                                <td align="right" class="px-3">
                                                                    <small><small>
                                                                    <?php
                                                                        $sqlMR = "SELECT COUNT(*) AS MR FROM risk WHERE closeStatus = 0 AND (cateory = 'Market Risk' AND keyRiskTag = 0)";
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="right" class="px-3">
                                                                    <small><small>
                                                                    <?php
                                                                        $sqlKROR = "SELECT COUNT(*) AS KROR FROM risk WHERE closeStatus = 0 AND (cateory = 'Operational Risk' AND keyRiskTag = 1)";
                                                                ...
                                                                <td align="right" class="px-3">
                                                                    <small><small>
                                                                    <?php
                                                                        $sqlROR = "SELECT COUNT(*) AS ROR FROM risk WHERE closeStatus = 0 AND (cateory = 'Operational Risk' AND keyRiskTag = 0)";
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="right" class="px-3">
                                                                    <small><small>
                                                                    <?php
                                                                        $sqlKRPR = "SELECT COUNT(*) AS KRPR FROM risk WHERE closeStatus = 0 AND (cateory = 'People Risk' AND keyRiskTag = 1)";
                                                                ...
                                                                <td align="right" class="px-3">
                                                                    <small><small>
                                                                    <?php
                                                                        $sqlPR = "SELECT COUNT(*) AS PR FROM risk WHERE closeStatus = 0 AND (cateory = 'People Risk' AND keyRiskTag = 0)";
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="right" class="px-3">
                                                                    <small><small>
                                                                    <?php
                                                                        $sqlKRPR = "SELECT COUNT(*) AS KRPR FROM risk WHERE closeStatus = 0 AND (cateory = 'Power Risk' AND keyRiskTag = 1)";
                                                                        $resultKRPR = mysqli_query($conn,$sqlKRPR) or die(mysqli_error($conn));
                                                                        $KRPR = mysqli_fetch_array($resultKRPR);
                                                                        $KRPR = $KRPR['KRPR'];
                                                                        echo    $KRPR;
                                                                ...
                                                                <td align="right" class="px-3">
                                                                    <small><small>
                                                                    <?php
                                                                        $sqlPR = "SELECT COUNT(*) AS PR FROM risk WHERE closeStatus = 0 AND (cateory = 'Power Risk' AND keyRiskTag = 0)";
                                                                        $resultPR = mysqli_query($conn,$sqlPR) or die(mysqli_error($conn));
                                                                        $PR = mysqli_fetch_array($resultPR);
                                                                        $PR = $PR['PR'];
                                                                        echo    $PR;
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="right" class="px-3">
                                                                    <small><small>
                                                                    <?php
                                                                        $sqlKRRR = "SELECT COUNT(*) AS KRRR FROM risk WHERE closeStatus = 0 AND (cateory = 'Regulatory Risk' AND keyRiskTag = 1)";
                                                                ...
                                                                <td align="right" class="px-3">
                                                                    <small><small>
                                                                    <?php
                                                                        $sqlRRR = "SELECT COUNT(*) AS RRR FROM risk WHERE closeStatus = 0 AND (cateory = 'Regulatory Risk' AND keyRiskTag = 0)";
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="right" class="px-3">
                                                                    <small><small>
                                                                    <?php
                                                                        $sqlKRReR = "SELECT COUNT(*) AS KRReR FROM risk WHERE closeStatus = 0 AND (cateory = 'Reputation Risk' AND keyRiskTag = 1)";
                                                                ...
                                                                <td align="right" class="px-3">
                                                                    <small><small>
                                                                    <?php
                                                                        $sqlReR = "SELECT COUNT(*) AS ReR FROM risk WHERE closeStatus = 0 AND (cateory = 'Reputation Risk' AND keyRiskTag = 0)";
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="right" class="px-3">
                                                                    <small><small>
                                                                    <?php
                                                                        $sqlKRSIR = "SELECT COUNT(*) AS KRSIR FROM risk WHERE closeStatus = 0 AND (cateory = 'Strategic Investment Risk' AND keyRiskTag = 1)";
                                                                ...
                                                                <td align="right" class="px-3">
                                                                    <small><small>
                                                                    <?php
                                                                        $sqlSIR = "SELECT COUNT(*) AS SIR FROM risk WHERE closeStatus = 0 AND (cateory = 'Strategic Investment Risk' AND keyRiskTag = 0)";
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="right" class="px-3">
                                                                    <small><small>
                                                                    <?php
                                                                        $sqlKRSPR = "SELECT COUNT(*) AS KRSPR FROM risk WHERE closeStatus = 0 AND (cateory = 'Strategic Partnership Risk' AND keyRiskTag = 1)";
                                                                ...
                                                                <td align="right" class="px-3">
                                                                    <small><small>
                                                                    <?php
                                                                        $sqlSPR = "SELECT COUNT(*) AS SPR FROM risk WHERE closeStatus = 0 AND (cateory = 'Strategic Partnership Risk' AND keyRiskTag = 0)";
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="right" class="px-3">
                                                                    <small><small>
                                                                    <?php
                                                                        $sqlKRTR = "SELECT COUNT(*) AS KRTR FROM risk WHERE closeStatus = 0 AND (cateory = 'Technology Risk' AND keyRiskTag = 1)";
                                                                ...
                                                                <td align="right" class="px-3">
                                                                    <small><small>
                                                                    <?php
                                                                        $sqlTR = "SELECT COUNT(*) AS TR FROM risk WHERE closeStatus = 0 AND (cateory = 'Technology Risk' AND keyRiskTag = 0)";
        ...
        <script type="text/javascript">
            ...
            <?php
                $sqlCountRiskLow = "SELECT COUNT(*) AS riskLow FROM risk WHERE resriskLevel = 'Low' AND riskResponse != 'Retain' AND closeStatus = 0";
            ...
            <?php
                $sqlCountRiskModerate = "SELECT COUNT(*) AS riskModerate FROM risk WHERE resriskLevel = 'Moderate' AND riskResponse != 'Retain' AND closeStatus = 0";
            ...
            <?php
                $sqlCountRiskHigh = "SELECT COUNT(*) AS riskHigh FROM risk WHERE resriskLevel = 'High' AND riskResponse != 'Retain' AND closeStatus = 0";
            ...
            <?php
                $sqlCountRiskSignificant = "SELECT COUNT(*) AS riskSignificant FROM risk WHERE resriskLevel = 'Significant' AND riskResponse != 'Retain' AND closeStatus = 0";
            ...
            <?php
                $sqlCountRiskExtreme = "SELECT COUNT(*) AS riskExtreme FROM risk WHERE resriskLevel = 'Extreme' AND riskResponse != 'Retain' AND closeStatus = 0";
            ...
            <?php
                ...
                $sqlMinMaxYr = "SELECT MIN(YEAR(reportedDate)) AS minYr FROM risk";
                ...
                for($yr = $minYr;$yr<=$maxYr;$yr++){
                    if($yr<$maxYr){
                        for($q = 1;$q<=4;$q++){
                            $sqlCountOpenRisk = "SELECT COUNT(*) AS tot FROM risk WHERE QUARTER(reportedDate) = '$q' AND YEAR(reportedDate) = '$yr'";
            ...
            <?php
                        ...
                        for($qf = 1;$qf<=$yearQuarter;$qf++){
                            $sqlCountOpenRisk = "SELECT COUNT(*) AS tot FROM risk WHERE QUARTER(reportedDate) = '$qf' AND YEAR(reportedDate) = '$yr'";
                            $resultCountOpenRisk = mysqli_query($conn,$sqlCountOpenRisk) or die(mysqli_error($conn));
                            $countOpenRisk = mysqli_fetch_array($resultCountOpenRisk);
                            $count = $countOpenRisk['tot'];
                            $c = $c + $count;
            ...
            <?php
                for($yr = $minYr;$yr<=$maxYr;$yr++){
                    if($yr<$maxYr){
                        for($q = 1;$q<=4;$q++){
                            $sqlCountOpenRisk = "SELECT COUNT(*) AS tot FROM risk WHERE closeStatus = 1 AND (QUARTER(closeDate) = '$q' AND YEAR(closeDate) = '$yr')";
                            $resultCountOpenRisk = mysqli_query($conn,$sqlCountOpenRisk) or die(mysqli_error($conn));
                            $countOpenRisk = mysqli_fetch_array($resultCountOpenRisk);
                            $count = $countOpenRisk['tot'];
                            $cc = $count;
