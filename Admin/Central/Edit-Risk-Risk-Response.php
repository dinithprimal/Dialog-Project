<?php
    ...
    $sqlUpdateBI = "UPDATE risk SET riskResponse = '$riskResponse' WHERE indexRisk = '$indexRisk'";
    if($conn->query($sqlUpdateBI) === TRUE){
        ...
        $queryActivity = "INSERT INTO activity (indexRisk, empNo, Date, Time, Des, field, intialValue, updatedValue) VALUES ('$indexRisk', '$empNo', '$Date', '$Time', 'Update Risk Response','Risk Response', '$initialVal', '$riskResponse')";
