<?php
    ...
    for($countAO = 0; $countAO<count($_POST['idActionOwners']); $countAO++){
        ...
        $slAO = "INSERT INTO actionowners (indexRisk, empNo) VALUES ('$indexRisk','$empAO')";
        if($conn->query($slAO) === TRUE){
            ...
            $queryActivity = "INSERT INTO activity (indexRisk, empNo, Date, Time, Des, field,  updatedValue) VALUES ('$indexRisk', '$empNo', '$Date', '$Time', 'New Action Owner','Action Owners', '$AOname')";
