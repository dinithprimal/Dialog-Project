                                                ...
                                                <div class="card-body" style="width: 100%;">
                                                    ...
                                                    <small>
                                                        ...
                                                        <table id="programsHistory" style="width:100%;" class="table table-sm table-striped table-hover">
                                                            ...
                                                            <tbody>
                                                            <?php
                                                                $querySelIndex = "SELECT indexRisk FROM trindex WHERE status = 'Active' ORDER BY id DESC";
                                                                ...
                                                                if(mysqli_num_rows($resultSelIndex) > 0){
                                                                    while($rowIndex = mysqli_fetch_array($resultSelIndex)){
                                                                        ...
                                                                        $query = "SELECT indexRisk, businessObj, description, cateory, mainUnit, currentStatus, reporter, reportedDate, keyRiskTag, closeStatus, reportedTime FROM risk WHERE indexRisk = '$index'";
