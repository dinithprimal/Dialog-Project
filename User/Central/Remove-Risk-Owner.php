<?php
    ...
    $slRO = "DELETE FROM riskowners WHERE empNo = '$empNo_remove'";
    if($conn->query($slRO) === TRUE){
        ...
        $queryActivity = "INSERT INTO activity (indexRisk, empNo, Date, Time, Des, field,  updatedValue) VALUES ('$indexRisk', '$empNo', '$Date', '$Time', 'Remove Risk Owner','Risk Owners', '$ROname')";
