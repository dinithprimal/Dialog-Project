<?php
    ...
    $sqlUpdateBI = "UPDATE risk SET mainUnit = '$mainUnit' WHERE indexRisk = '$indexRisk'";
    if($conn->query($sqlUpdateBI) === TRUE){
        ...
        $queryActivity = "INSERT INTO activity (indexRisk, empNo, Date, Time, Des, field, intialValue, updatedValue) VALUES ('$indexRisk', '$empNo', '$Date', '$Time', 'Update Main Unit','Main Unit', '$initialVal', '$mainUnit')";
