<?php
    ...
    if(isset($_SESSION['user'])){
        ...
        $queryUserDetails = "SELECT idUser, empNo, fullName, role FROM user_details WHERE username = '$username'";
                                                ...
                                                <div class="card-body" style="width: 100%;">
                                                    ...
                                                    <small>
                                                        ...
                                                        <table id="programsHistory" style="width:100%;" class="table table-sm table-striped table-hover">
                                                            ...
                                                            <tbody>
                                                            <?php
                                                                $querySelIndex = "SELECT * FROM risk WHERE reporter = '$empNoUser' ORDER BY idRisk DESC";
                                                ...
                                                <div class="card-body" style="width: 100%;">
                                                    ...
                                                    <small>
                                                        ...
                                                        <table id="riskOwnerTable" style="width:100%;" class="table table-sm table-striped table-hover">
                                                            ...
                                                            <tbody>
                                                            <?php
                                                                $querySelIndex = "SELECT indexRisk FROM riskowners WHERE empNo = '$empNoUser'";
                                                                $resultSelIndex = mysqli_query($conn, $querySelIndex);
                                                                if(mysqli_num_rows($resultSelIndex) > 0){
                                                                    while($rowIndex = mysqli_fetch_array($resultSelIndex)){
                                                                        $index = $rowIndex['indexRisk'];
                                                                        $query = "SELECT indexRisk, cateory, mainUnit, currentStatus, reporter, reportedDate, keyRiskTag, closeStatus, reportedTime FROM risk WHERE indexRisk = '$index'";
                                                ...
                                                <div class="card-body" style="width: 100%;">
                                                    ...
                                                    <small>
                                                        ...
                                                        <table id="actionOwnerTable" style="width:100%;" class="table table-sm table-striped table-hover">
                                                            ...
                                                            <tbody>
                                                            <?php
                                                                $querySelIndex = "SELECT indexRisk FROM actionowners WHERE empNo = '$empNoUser'";
                                                                $resultSelIndex = mysqli_query($conn, $querySelIndex);
                                                                if(mysqli_num_rows($resultSelIndex) > 0){
                                                                    while($rowIndex = mysqli_fetch_array($resultSelIndex)){
                                                                        $index = $rowIndex['indexRisk'];
