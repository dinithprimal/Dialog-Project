                            ...
                            <div class="container">
                                <div class="row g-1 g-lg-2">
                                    <div class="col-xl-3 col-lg-6">
                                        <div class="p-1">
                                            <div class="card" style="width: auto; height: 155px;">
                                                <div class="card-body">
                                                    <h5 class="card-title">Risks</h5>
                                                    <h6 class="card-subtitle mb-2 text-muted"><small>View all registered risks</small></h6>
                                                    <br>
                                                    <div class="d-grid gap-2">
                                                        <a href="All-Risks.php" class="btn btn-info btn-md" tabindex="-1" role="button">Goto Risks Page</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xl-6 col-lg">
                                        <div class="p-1">
                                            <div class="card" style="width: auto; height: 155px;">
                                                <div class="card-body">
                                                    <h5 class="card-title">Update Risks</h5>
                                                    <h6 class="card-subtitle mb-2 text-muted"><small>Update registered risks for this time period</small></h6>
                                                    <div class="row px-4">
                                                    <?php
                                                    ...
                                                    ?>
                                                        <div class="col-xl-12 col-lg-12 pb-1 align-item-center">
                                                            <small><small><span style="float:left">Description :</span></small></small>
                                                            <small><small><span style="float:right"><b><?php   echo    $infoProg['Name'];    ?></b></span></small></small>
                                                        </div>
                                                        <div class="col-xl-12 col-lg-12 pb-1 align-item-center mt-1">
                                                        <?php
                                                            $value = $infoProg['endDate'];
                                                            $datetime = new DateTime($value);
                                                        ?>
                                                            <small><small><span style="float:left">Due Date / Time :</span></small></small>
                                                            <small><small><span style="float:right"><?php   echo    $datetime->format("l, d F Y, h:i A");   ?></span></small></small>
                                                        </div>
                                                        <div class="col-xl-12 col-lg-12 pb-1 align-item-center mt-1">
                                                        <?php
                                                            $now = new DateTime();
                                                        ...
                                                        ?>
                                                            <small><small><span style="float:left" class="<?php    if($datetime < $now){   echo    "text-danger"; }  ?>">
                                                        <?php
                                                            if($datetime > $now){
                                                        ?>
                                                                Time Remaining :
                                                        ...
                                                        ?>   
                                                            ...
                                                            <small><small><span style="float:right" class="<?php    if($datetime < $now){   echo    "text-danger"; }else{   echo    "text-success"; }  ?>">
                                                            <?php
                                                    ...
                                                    ?>
                                                        <div class="col-xl-12 col-lg-12 pb-1 align-item-center mt-3">
                                                            <small><small><span class="text-danger" style="float:left">No infomation gather program active. You can update risks by default.</span></small></small>
                                                        </div>      
                                                    <?php
                                                        }
                                                    ?>
                                        ...
                                        <div class="p-1">
                                            <div class="card" style="width: auto; height: 470px;">
                                                <div class="card-body">
                                                    ...
                                                    <br>
                                                    <div class="d-grid gap-2">
                                                        <div class="table-responsive d-flex" style="height: 360px; overflow: auto; overflow-x: auto; overflow-y: auto;">
                                                            <table class="table table-sm table-striped table-hover">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        ?>
                                                                        <td><small><small><a href="View-Risk.php?id=<?php  echo    $activity['indexRisk']; ?>"><?php   echo    $activity['indexRisk'];  if($risk['keyRiskTag'] == 1){ ?><span class="text-danger"> KR</span><?php  }   if($risk['closeStatus'] == 1){ ?><span class="text-danger"> Closed</span><?php  }   ?></a></small></td>
