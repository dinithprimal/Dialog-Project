<?php
    ...
    $sqlUpdateBI = "UPDATE risk SET businessObj = '$businessImpact' WHERE indexRisk = '$indexRisk'";
    if($conn->query($sqlUpdateBI) === TRUE){
        ...
        $queryActivity = "INSERT INTO activity (indexRisk, empNo, Date, Time, Des, field, intialValue, updatedValue) VALUES ('$indexRisk', '$empNo', '$Date', '$Time', 'Update Business Impact','Business Impact', '$initialVal', '$businessImpact')";
