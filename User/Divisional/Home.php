                                                            ...
                                                            <table class="table table-sm table-striped table-hover">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                        ...
                                                                        $queryActivity = "SELECT * FROM divactivity WHERE indexRisk IN (SELECT indexRisk FROM divrisk WHERE mainUnit = '$department' OR reporter = '$empNoUser' UNION SELECT indexRisk FROM divriskowners WHERE empNo = '$empNoUser' UNION SELECT indexRisk FROM divactionowners WHERE empNo = '$empNoUser') ORDER BY idActivity DESC LIMIT 20";
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <?php
                                                                            $queryRisk = "SELECT keyRiskTag, closeStatus FROM divrisk WHERE indexRisk = '".$activity['indexRisk']."'";
