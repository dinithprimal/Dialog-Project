<?php
    ...
    if(isset($_SESSION['user'])){
        ...
        $queryUserDetails = "SELECT idUser, fullName, empNo, role, category, department FROM user_details WHERE username = '$username'";
...
<html lang="en">
    ...
    <body>
        ...
        <?php
            ...
            $sqlRiskReporter = "SELECT COUNT(*) AS repTot FROM divrisk WHERE indexRisk = '$riskIndex' AND reporter = '$empNo'";
            ...
            $sqlRiskOwnership = "SELECT COUNT(*) AS ownTot FROM divriskowners WHERE indexRisk = '$riskIndex' AND empNo = '$empNo'";
            ...
            $sqlActionOwnership = "SELECT COUNT(*) AS actTot FROM divactionowners WHERE indexRisk = '$riskIndex' AND empNo = '$empNo'";
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mt-2 px-2">
                            <textarea class="form-control form-control-sm" maxlength="1500" onkeypress="maxLengthCheck(this)" id="closeRiskComment" rows="3" onclick="enableCloseRiskComment();" onkeyup="enableCloseRiskComment()"></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-sm btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                    ...
                                    <span class="text-danger"><small><small><small>
                                        <?php
                                            if($activeStatus == "Inactive"){
                                                ...
                                                echo    "This risk requested to transfer to ERM and await for admin approval";
                                            }
                                        ?>
                                    </small></small></small>
                                </h4>
                                                        ...
                                                        <div class="col mb-4 mb-lg-1">
                                                            <div class="row justify-content-between align-item-center">
                                                                <div class="col align-item-center">
                                                                    <button style="float: right" data-bs-toggle="modal" data-bs-target="#ReOpen" type="button" class="btn btn-sm btn-info mx-2" <?php if(($riskReporter == 0) & ($riskOwnership == 0)){   echo    "disabled";  }  ?>>Open Again</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            if($risk_details['closeStatus'] == 0){
                                                if($riskReporter == 0){
                                                    if($userCategory == "Head"){
                                                        if(($riskOwnership == 0)){
                                        ?>
                                            <button type="button" id="addMeRiskOwner" name="addMeRiskOwner" class="btn btn-sm btn-primary mx-2" style="float: right;">Add Me as a Risk Owner</button>
                                        <?php
                                                        }
                                                    }
                                                }
                                            ...
                                            <div class="card" style="width: auto; height: auto;">
                                                ...
                                                <div class="card-body">
                                                            ...
                                                            <div class="table-responsive d-flex" style="height: 200px; overflow: auto; overflow-x: auto; overflow-y: auto;">
                                                                    <table class="table table-sm table-hover">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            ?>
                                                                            <tr>
                                                                                <td><small><small><?php if($countRow>0){    echo    "<del>";    }   echo    $deadline['deadline'];  if($countRow>0){    echo    "</del>";    } ?></del></small></small></td>
                                                                                <td>
                                                                                    <small><small>
                                                                                        <?php
                                                                                            if($countRow>0){
                                                    ...
                                                    <?php
                                                        if($risk_details['closeStatus'] == 0){
                                                    ?>
                                                        <button data-bs-toggle="modal" data-bs-target="#Close-Risk" type="button" class="btn btn-sm btn-danger mx-2" <?php if((($riskReporter == 0) & ($riskOwnership == 0)) | ($activeStatus != "Active")){   echo    "disabled";  }  ?>>Close this Risk</button>
                                                    <?php
                                                        }
                                                    ?>
                                                    </div>
        ...
        <script type="text/javascript">
            ...
            $('#requestSendDivision').click(function(){
                if(confirm("Are you sure you want to request this risk send to ERM?")){
