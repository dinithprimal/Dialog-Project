...
<html lang="en">
    <head>
        ...
        <title>All Risks - Risk Register Management System</title>
    </head>
    <body>
        <!-- navbar -->
                                    ...
                                    <div class="col">
                                            <div class="card" style="width: auto; height: auto;">
                                                <div class="card-body" style="width: 100%;">
                                                    ...
                                                    <h6 class="card-subtitle mb-2 text-muted"><small>Shown all registered risks in your division. Please select the risk to view and update.</small></h6>
                                                    <br>
                                                    <small>
                                                        ...
                                                        <table id="programsHistory" style="width:100%;" class="table table-sm table-striped table-hover">
                                                            ...
                                                            <tbody>
                                                            <?php
                                                                /* $querySelIndex = "SELECT indexRisk FROM divtrindex WHERE status = 'Active' ORDER BY id DESC";
                                                                ...
                                                                if(mysqli_num_rows($resultSelIndex) > 0){
                                                                    while($rowIndex = mysqli_fetch_array($resultSelIndex)){ */
                                                                        ...
                                                                        $query = "SELECT indexRisk, businessObj, description, cateory, mainUnit, currentStatus, reporter, reportedDate, keyRiskTag, closeStatus, reportedTime FROM divrisk WHERE indexRisk IN (SELECT indexRisk FROM divtrindex WHERE status != 'Inactive') AND mainUnit = '$department'";
