<?php
    ...
    if(isset($_SESSION['user'])){
        ...
        $queryUserDetails = "SELECT idUser,fName, lName, fullName, empNo, role, category, department FROM user_details WHERE username = '$username'";
                                                ...
                                                <div class="card-body p-3">
                                                    <div class="form-control p-3 mb-3">
                                                        ...
                                                        <div class="row d-flex justify-content-between align-items-center mt-3">
                                                            ...
                                                            <div class="col-8">
                                                                <select name="mainUnit" id="mainUnit" class="form-control form-select" onfocusout="remmoveErrorRiskUnit(this)" aria-label="Default select example" style="width: 70%;" disabled>
                                                                <option selected class="text-muted">Select Unit</option>
                                                                <option <?php   if($department == "Access Planning"){ echo    "selected";  }  ?>>Access Planning</option>
                                                                <option <?php   if($department == "Broadband Planning"){ echo    "selected";  }  ?>>Broadband Planning</option>
                                                                <option <?php   if($department == "CFSS"){ echo    "selected";  }  ?>>CFSS</option>
                                                                <option <?php   if($department == "Core Network Planning"){ echo    "selected";  }  ?>>Core Network Planning</option>
                                                                <option <?php   if($department == "Data Center & Power Systems"){ echo    "selected";  }  ?>>Data Center & Power Systems</option>
                                                                <option <?php   if($department == "DE-TAC"){ echo    "selected";  }  ?>>DE-TAC</option>
                                                                <option <?php   if($department == "DNS"){ echo    "selected";  }  ?>>DNS</option>
                                                                <option <?php   if($department == "DTV"){ echo    "selected";  }  ?>>DTV</option>
                                                                <option <?php   if($department == "GTD"){ echo    "selected";  }  ?>>GTD</option>
                                                                <option <?php   if($department == "Network Strategy"){ echo    "selected";  }  ?>>Network Strategy</option>
                                                                <option <?php   if($department == "NOSA - ANO"){ echo    "selected";  }  ?>>NOSA - ANO</option>
                                                                <option <?php   if($department == "NOSA - Core Network"){ echo    "selected";  }  ?>>NOSA - Core Network</option>
                                                                <option <?php   if($department == "NOSA - CRC"){ echo    "selected";  }  ?>>NOSA - CRC</option>
                                                                <option <?php   if($department == "NOSA - Enterprise Service Support"){ echo    "selected";  }  ?>>NOSA - Enterprise Service Support</option>
                                                                <option <?php   if($department == "NOSA - Enterprise Service Support (IDC)"){ echo    "selected";  }  ?>>NOSA - Enterprise Service Support (IDC)</option>
                                                                <option <?php   if($department == "NOSA - Enterprise Service Support (SD)"){ echo    "selected";  }  ?>>NOSA - Enterprise Service Support (SD)</option>
                                                                <option <?php   if($department == "NOSA - NSQ"){ echo    "selected";  }  ?>>NOSA - NSQ</option>
                                                                <option <?php   if($department == "NOSA - PS & International"){ echo    "selected";  }  ?>>NOSA - PS & International</option>
                                                                <option <?php   if($department == "NOSA - TNO"){ echo    "selected";  }  ?>>NOSA - TNO</option>
                                                                <option <?php   if($department == "NOSA - VAS"){ echo    "selected";  }  ?>>NOSA - VAS</option>
                                                                <option <?php   if($department == "Product Development"){ echo    "selected";  }  ?>>Product Development</option>
                                                                <option <?php   if($department == "Project Planning"){ echo    "selected";  }  ?>>Project Planning</option>
                                                                <option <?php   if($department == "TNP"){ echo    "selected";  }  ?>>TNP</option>
                                                                <option <?php   if($department == "TSC"){ echo    "selected";  }  ?>>TSC</option>
                                                            </select>
                                                ...
                                                <div class="card-body p-3">
                                                    <div class="form-control p-3 mb-3">
                                                        <div class="row d-flex justify-content-between align-items-center">
                                                            ...
                                                            <div class="col-8">
                                                                <select name="riskResponse" id="riskResponse" class="form-control form-select" onchange="remmoveErrorResLikeGR(this)" onfocusout="remmoveErrorRiskRes(this)" aria-label="Default select example" style="width: 70%;">
