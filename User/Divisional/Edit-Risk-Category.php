<?php
    ...
    $sqlUpdateBI = "UPDATE divrisk SET cateory = '$riskCategory' WHERE indexRisk = '$indexRisk'";
    if($conn->query($sqlUpdateBI) === TRUE){
        ...
        $queryActivity = "INSERT INTO divactivity (indexRisk, empNo, Date, Time, Des, field, intialValue, updatedValue) VALUES ('$indexRisk', '$empNo', '$Date', '$Time', 'Update Risk Category','Risk Category', '$initialVal', '$riskCategory')";
