<?php
    ...
    $slAO = "INSERT INTO divinfogather (Name, startDate, endDate, division, status) VALUES ('$name','$Date','$DLDate','$division','0')";
    if($conn->query($slAO) === TRUE){
        ...
        //$selectDivisionRisks = ""
            ...
            $mail->Body   .= 'As requested by Divisional Risk Registry - '$division' Division, it is necessary to provide an update of Group Technology Divisional Risk Registry for <b>'.$name.'</b>. Please note that system will only open till '.$emailDL.'.<br><br>';
            $mail->Body   .= '<ul>';
